// File: backend/src/main/java/com/enterprise/core/tasks/repository/TaskRepository.java
package com.enterprise.modules.tasks.repository;
...
public interface TaskRepository extends JpaRepository<Task, Long> {
    ...
    // Find subtasks of a parent tasks
    ...
    // Find tasks assigned to a user in a modules
