...
const LeadsPage = () => {
  ...
  // Open form panel for creating a new lead
  const handleCreateLead = () => {
    setCurrentLead(null);  // No lead for creation mode
    setIsFormPanelOpen(true);
  };

  // Open form panel for editing an existing lead
  ...
  return (
    <div className={containerStyles}>
      ...
      <Panel
        ...
        headerText={currentLead ? "Edit Lead" : "New Lead"}
      ...
      <Dialog
        ...
        dialogContentProps={{
          ...
          title: 'Delete Lead',
          subText: `Are you sure you want to delete ${leadsToDelete.length} lead(s)? This action cannot be undone.`
        }}
        modalProps={{
          isBlocking: true
        }}
